...
[Part 1  describes the necesarry roles in the Management and Development Model](https://logius-standaarden.github.io/BOMOS-Fundament/en/index.html#activiteiten-en-rollen),and linked to the main activities of BOMOS. We will now look in more detail in the opposite direction. Starting with the roles, the table below identifies the BOMOS activities in which they are involved; this also demonstrates that a 1-on-1 connection between role and activity cannot work.
...
[**Module development**](https://logius-standaarden.github.io/BOMOS-Fundament/en/index.html#de-onderwerpen-uit-het-model);
