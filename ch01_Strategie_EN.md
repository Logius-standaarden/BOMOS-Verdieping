...
<p class="comment" style="color:red">
<aside class="example" title="Template voor management document and calculation model of Geonovum">
...
* A hobbyist approach in the positive sense of the word.
...
The first step starts with analysing stakeholders; what parties have a relationship with the interoperability problem for which a standard could offer a solution. To identify the stakeholders, the NEN stakeholder analysis can be used (see [[[#method-of-decision-making]]]).
